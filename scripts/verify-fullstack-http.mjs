...
for (const path of paths) {
  ...
  assert.match(html,/Morgan Retailers|MORGAN RETAILERS/,path);
...
const www=await get("/","www.thefullstackguys.com");assert.equal(www.status,200);assert.match(await www.text(),/MORGAN RETAILERS/);
