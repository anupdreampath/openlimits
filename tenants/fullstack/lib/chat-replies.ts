...
export function answerFallback(
  ...
  if (/\b(?:gst|gstin|legal name|business name|company name|who operates|who owns|fullstack|morgan retailers)\b/.test(latest)) {
    return `TheFullStack Guys is the website name. The business and brand is MORGAN RETAILERS, GSTIN 07ANVPC6122B1ZA. Business address: ${OFFICE_ADDRESS}. Direct project agreements and invoices are issued by Morgan Retailers.`;
  }
