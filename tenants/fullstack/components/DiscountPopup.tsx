...
export function DiscountPopup({
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError("Connection dipped. Try once more or contact the team directly.");
    } finally {
            ...
            <div className="discount-pop__content">
              ...
              {claimedCode ? (
                ...
                <form className="discount-pop__form" onSubmit={handleSubmit}>
                  ...
                  <p className="inquiry-privacy">Morgan Retailers uses these details to respond to your project inquiry. No newsletter signup. <a href="/privacy-policy">Privacy policy</a> · <a href="/terms-of-use">Offer terms</a></p>
