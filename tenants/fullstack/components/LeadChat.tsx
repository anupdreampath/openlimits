    ...
    <>
      ...
      >
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Morgan Retailers project chat"
          tabIndex={-1}
        >
          <div className="lead-chat__header">
            <div>
              <span>MORGAN RETAILERS BRAIN</span>
          ...
          <p className="inquiry-privacy">Morgan Retailers’ automated assistant. Messages are processed to answer your inquiry; authorized staff may review them. Do not share passwords or payment details. <a href="/privacy-policy">Privacy policy</a> · <a href="/terms-of-use">Terms</a></p>
          <form className="lead-chat__form" onSubmit={handleSubmit}>
            <textarea
              ...
              aria-label="Message to Morgan Retailers"
              enterKeyHint="send"
              rows={2}
            />
            <button
